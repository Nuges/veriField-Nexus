...
class Article6Provider(RegistryProvider):
    def __init__(self):
        if not getattr(settings, "ENABLE_ARTICLE6".lower(), False):
            raise NotImplementedError("Article6Provider is disabled by feature flag ENABLE_ARTICLE6.")
