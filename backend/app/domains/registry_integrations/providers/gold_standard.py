...
class GoldStandardProvider(RegistryProvider):
    def __init__(self):
        if not getattr(settings, "ENABLE_GOLD_STANDARD_SYNC".lower(), False):
            raise NotImplementedError("GoldStandardProvider is disabled by feature flag ENABLE_GOLD_STANDARD_SYNC.")
