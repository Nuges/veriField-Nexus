...
class VerraProvider(RegistryProvider):
    def __init__(self):
        if not getattr(settings, "ENABLE_VERRA_SYNC".lower(), False):
            raise NotImplementedError("VerraProvider is disabled by feature flag ENABLE_VERRA_SYNC.")
