...
class MethodologyFamily(Base):
    ...
    project_types: Mapped[list] = mapped_column(JSONB, default=list, server_default='[]')
...
class Methodology(Base):
    ...
    recommendation_rules: Mapped[dict] = mapped_column(JSONB, default=dict, server_default='{}')
