...
class MethodologyService:
    ...
    async def recommend_methodologies(self, sector_id: UUID, project_type_id: str, country: str) -> dict:

        # Get methodologies in the sector
        ...
        result = await self.db.execute(
            ...
            .where(Methodology.family_id == sector_id)

            .order_by(Methodology.code)

        )

        methodologies = list(result.scalars().all())
        ...
        for m in methodologies:
            ...
            rules = m.recommendation_rules or {}

            pts = rules.get("project_types", [])

            countries = rules.get("countries", ["Global"])



            if project_type_id in pts and (country in countries or "Global" in countries):
                ...
                if not recommended:
                    ...
                    recommended = {
                        ...
                        "reason": rules.get("reason", "Matches your project type and country."),
