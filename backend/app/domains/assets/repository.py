...
class AssetRepository:
    ...
    async def list_by_organization(
        ...
        self, organization_id: UUID, project_id: Optional[UUID] = None, sector_id: Optional[UUID] = None
        ...
        if sector_id:
            ...
            stmt = stmt.join(Project, Asset.project_id == Project.id).where(Project.sector_id == sector_id)
