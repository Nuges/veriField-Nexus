...
async def list_assets(
    ...
    effective_offset = offset or ((page - 1) * effective_limit)
    ...
    sliced_assets = assets[effective_offset:effective_offset + effective_limit] if len(assets) > effective_limit else assets

    return [AssetResponse.model_validate(a) for a in sliced_assets]
