...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      debugPrint('[RegisterScreen] Registering via ApiService');
      ...
      debugPrint('[RegisterScreen] ApiService signup completed. Response: $response');
      ...
      if (mounted) {
        ...
        if (response['access_token'] != null) {
          ...
          await ApiService.setCustomToken(response['access_token']);
