...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _showCustomUrlDialog() {
    ...
    final controller = TextEditingController(text: ApiService.apiBaseUrl);
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Configure Backend Server URL', style: AppTypography.body.copyWith(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: AppTypography.bodySmall.copyWith(fontSize: 11, fontFamily: 'monospace', color: AppColors.primary),
