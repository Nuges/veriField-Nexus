    ...
    <section className="relative bg-[#03060A] text-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden border-b border-zinc-900/50">
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        >
          <Link
            href="/signup"
            className="flex items-center justify-center h-11 px-6 rounded-md bg-white text-zinc-900 font-medium text-xs tracking-tight hover:bg-zinc-100 transition-colors border border-white"
          >
            Request Access
          </Link>
        </motion.div>
