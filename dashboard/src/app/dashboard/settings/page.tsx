...
import MFASettingsComponent from "@/components/MFASettings";
    ...
    <div className="space-y-6 max-w-4xl pb-12">
      ...
      {activeTab === "profile" && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs bg-[var(--color-background)] border border-[var(--color-border)] rounded-xl p-3 text-[var(--color-text-primary)] focus:outline-none focus:border-emerald-500 font-medium"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Mail className="absolute left-3.5 top-3.5 text-emerald-500 shrink-0" size={16} />
                      ...
                      <input
                        ...
                        className="w-full pl-10 text-xs bg-[var(--color-background)] border border-[var(--color-border)] rounded-xl p-3 text-[var(--color-text-primary)] font-semibold cursor-not-allowed select-all"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <ShieldCheck className="absolute left-3.5 top-3.5 text-emerald-500 shrink-0" size={16} />
                      ...
                      <input
                        ...
                        value={
                          ...
                          user?.role === "ORG_ADMIN" || user?.role === "admin" ? "Organization Admin" :

                          user?.role || "Field Agent"

                        }

                        className="w-full pl-10 text-xs bg-[var(--color-background)] border border-[var(--color-border)] rounded-xl p-3 text-[var(--color-text-primary)] font-bold cursor-not-allowed uppercase tracking-wider select-all"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Building className="absolute left-3.5 top-3.5 text-emerald-500 shrink-0" size={16} />
                      ...
                      <input
                        ...
                        className="w-full pl-10 text-xs bg-[var(--color-background)] border border-[var(--color-border)] rounded-xl p-3 text-[var(--color-text-primary)] font-extrabold cursor-not-allowed select-all"
                ...
                <div className="flex justify-end pt-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 text-white font-medium hover:bg-emerald-600 transition-colors shadow-lg shadow-emerald-500/20 disabled:opacity-50 cursor-pointer"
          ...
          {/* Right Column: Two-Factor Authentication, Settings Guide, and Session Control */}
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            {/* 2. SETTINGS GUIDE Card (Under Two-Factor Authentication) */}
            ...
            {/* 3. SESSION CONTROL Card (Under Two-Factor Authentication & Settings Guide) */}
            ...
            <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-2xl p-5 shadow-sm space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500 text-red-400 hover:text-white font-medium transition-all shadow-xs border border-red-500/20 cursor-pointer"
